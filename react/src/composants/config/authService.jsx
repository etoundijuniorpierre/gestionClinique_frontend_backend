...
class AuthService {
  ...
  clearLocalSession() {
    // Sauvegarder le nom d'utilisateur mémorisé si présent et valide
    ...
    // Remettre le nom d'utilisateur mémorisé seulement s'il est valide
    if (rememberedUsername && rememberedUsername !== 'null' && rememberedUsername !== 'undefined') {
